...
## Plugin Identifiers
- **Manufacturer Code**: `Ycom` (YourCompany)
...
1. Open Logic Pro
2. Navigate: **Audio Units → YourCompany → Surround Delay**
...
### After Code Changes
1. **Build**: `Shift+F7` in VS Code
2. **Validate**: `auval -v aufx Srdl Ycom` (only if needed)
3. **Test**: Launch Logic Pro (may need to reload plugin)
...
- Build artifacts are in `build/SurroundDelay_artefacts/`
